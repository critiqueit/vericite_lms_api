...
```sh
pip install git+https://github.com/critiqueit/vericite_lms_api.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/critiqueit/vericite_lms_api.git`)
