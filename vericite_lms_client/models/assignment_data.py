...
class AssignmentData(object):
    ...
    def __init__(self, assignment_attachment_external_content=None, assignment_due_date=None, assignment_enable_student_preview=None, assignment_exclude_quotes=None, assignment_exclude_self_plag=None, assignment_grade=None, assignment_instructions=None, assignment_store_in_index=None, assignment_title=None):
        """
        AssignmentData - a model defined in Swagger
        """

        self._assignment_attachment_external_content = None
        self._assignment_due_date = None
        self._assignment_enable_student_preview = None
        self._assignment_exclude_quotes = None
        self._assignment_exclude_self_plag = None
        self._assignment_grade = None
        self._assignment_instructions = None
        self._assignment_store_in_index = None
        self._assignment_title = None

        if assignment_attachment_external_content is not None:
          self.assignment_attachment_external_content = assignment_attachment_external_content
        if assignment_due_date is not None:
          self.assignment_due_date = assignment_due_date
        if assignment_enable_student_preview is not None:
          self.assignment_enable_student_preview = assignment_enable_student_preview
        if assignment_exclude_quotes is not None:
          self.assignment_exclude_quotes = assignment_exclude_quotes
        if assignment_exclude_self_plag is not None:
          self.assignment_exclude_self_plag = assignment_exclude_self_plag
        ...
        if assignment_store_in_index is not None:
          self.assignment_store_in_index = assignment_store_in_index
    ...
    @property
    def assignment_enable_student_preview(self):
        """
        Gets the assignment_enable_student_preview of this AssignmentData.
        set status for enableStudentPreview

        :return: The assignment_enable_student_preview of this AssignmentData.
        :rtype: bool
        """
        return self._assignment_enable_student_preview

    @assignment_enable_student_preview.setter
    def assignment_enable_student_preview(self, assignment_enable_student_preview):
        """
        Sets the assignment_enable_student_preview of this AssignmentData.
        set status for enableStudentPreview

        :param assignment_enable_student_preview: The assignment_enable_student_preview of this AssignmentData.
        :type: bool
        """

        self._assignment_enable_student_preview = assignment_enable_student_preview
    ...
    def assignment_title(self, assignment_title):
        ...
        if assignment_title is None:
            raise ValueError("Invalid value for `assignment_title`, must not be `None`")
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, AssignmentData):
            return False
