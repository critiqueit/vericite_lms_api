...
class ExternalContentData(object):
    ...
    def __init__(self, external_content_id=None, file_name=None, upload_content_length=None, upload_content_type=None):
        ...
        self._upload_content_length = None
        self._upload_content_type = None

        self.external_content_id = external_content_id
        self.file_name = file_name
        self.upload_content_length = upload_content_length
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ExternalContentData):
            return False
