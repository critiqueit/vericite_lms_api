...
class ReportsApi(object):
    ...
    def get_report_urls(self, context_id, assignment_id_filter, consumer, consumer_secret, token_user, token_user_role, **kwargs):
        ...
        :return: list[ReportURLLinkResponse]
    ...
    def get_report_urls_with_http_info(self, context_id, assignment_id_filter, consumer, consumer_secret, token_user, token_user_role, **kwargs):
        ...
        if 'assignment_id_filter' in params:
            query_params.append(('assignmentIDFilter', params['assignment_id_filter']))
        if 'user_id_filter' in params:
            query_params.append(('userIDFilter', params['user_id_filter']))
        if 'external_content_id_filter' in params:
            query_params.append(('externalContentIDFilter', params['external_content_id_filter']))
        if 'print_report_page' in params:
            query_params.append(('printReportPage', params['print_report_page']))
        if 'token_user' in params:
            query_params.append(('tokenUser', params['token_user']))
        if 'token_user_role' in params:
            query_params.append(('tokenUserRole', params['token_user_role']))
        ...
        return self.api_client.call_api('/reports/urls/{contextID}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='list[ReportURLLinkResponse]',
    ...
    def get_scores_with_http_info(self, context_id, consumer, consumer_secret, **kwargs):
        ...
        if 'assignment_id' in params:
            query_params.append(('assignmentID', params['assignment_id']))
        if 'user_id' in params:
            query_params.append(('userID', params['user_id']))
        if 'external_content_id' in params:
            query_params.append(('externalContentID', params['external_content_id']))
        ...
        return self.api_client.call_api('/reports/scores/{contextID}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def submit_request(self, context_id, assignment_id, user_id, consumer, consumer_secret, report_meta_data, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.submit_request(context_id, assignment_id, user_id, consumer, consumer_secret, report_meta_data, callback=callback_function)
        ...
        :param bool immediate_score_only: Will only run the report for immediate scoring
        :param bool encrypted: Flag to indicate encryption
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.submit_request_with_http_info(context_id, assignment_id, user_id, consumer, consumer_secret, report_meta_data, **kwargs)
        else:
            (data) = self.submit_request_with_http_info(context_id, assignment_id, user_id, consumer, consumer_secret, report_meta_data, **kwargs)
            return data

    def submit_request_with_http_info(self, context_id, assignment_id, user_id, consumer, consumer_secret, report_meta_data, **kwargs):
        """
        Request a file submission
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.submit_request_with_http_info(context_id, assignment_id, user_id, consumer, consumer_secret, report_meta_data, callback=callback_function)
        ...
        all_params = ['context_id', 'assignment_id', 'user_id', 'consumer', 'consumer_secret', 'report_meta_data', 'immediate_score_only', 'encrypted']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'immediate_score_only' in params:
            query_params.append(('immediateScoreOnly', params['immediate_score_only']))
        ...
        return self.api_client.call_api('/reports/submit/request/{contextID}/{assignmentID}/{userID}', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
